...
public class MenuService {
	...
	public static ItemMenu[] createMainMenu() {
		...
		itemsMenu[0] = new ItemMenu(items[0], R.drawable.ic_list, 0);
		itemsMenu[1] = new ItemMenu(items[1], R.drawable.ic_shopping, 0);
		itemsMenu[2] = new ItemMenu(items[2], R.drawable.ic_note, 0);
		itemsMenu[3] = new ItemMenu(items[3], R.drawable.ic_wallet, 0);
		return itemsMenu;
	}
